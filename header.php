...
<a href="index.php"><picture><source srcset="images/bg.webp" type="image/webp"><img class="h-[50px]" src="<?php echo getSetting('header_logo') ?: 'images/bg.png'; ?>" alt="<?php echo escSetting('site_name'); ?>" width="200" height="50" /></picture></a>
