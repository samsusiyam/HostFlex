...
<div class="relative" id="desktopCurrencyWrapper">
    <button type="button" onclick="toggleCurrencyMenu('desktopCurrencyDropdown')" class="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl border border-gray-200 bg-gray-50 hover:bg-gray-100 text-xs font-bold text-gray-800 transition cursor-pointer shadow-2xs">
    ...
    <div id="desktopCurrencyDropdown" class="hidden absolute right-0 top-full mt-2 w-44 bg-white border border-gray-100 rounded-2xl shadow-2xl p-1.5 z-[999999] animate-fadeIn" style="min-width: 160px;">
        ...
        <a href="<?php echo htmlspecialchars(getCurrencySwitchUrl($c_code)); ?>" class="flex items-center justify-between px-3 py-2 text-xs font-bold rounded-xl transition <?php echo $user_curr['code'] === $c_code ? 'bg-blue-50 text-blue-600 font-extrabold' : 'text-gray-700 hover:bg-gray-50 hover:text-blue-600'; ?>">
            <div class="flex items-center gap-2.5">
                <span class="w-5 text-center text-blue-600 font-black text-sm"><?php echo htmlspecialchars($c_item['symbol']); ?></span>
...
<div class="relative shrink-0" id="mobileCurrencyWrapper">
    <button type="button" onclick="toggleCurrencyMenu('mobileCurrencyDropdown')" class="flex items-center gap-1.5 px-3 py-2 rounded-lg border border-gray-200 bg-gray-50 hover:bg-gray-100 text-xs font-bold text-gray-800 transition cursor-pointer shrink-0">
        <span class="text-blue-600 font-black text-sm"><?php echo htmlspecialchars($user_curr['symbol']); ?></span>
