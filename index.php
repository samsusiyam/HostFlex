...
<h1 class="flex flex-col gap-2 text-[24px] font-extrabold capitalize leading-[32px] md:text-[36px] md:leading-[45px] xl:text-[46px]"><span class="text-[#111827]"><?php echo htmlspecialchars($c['tagline'] ?? ''); ?></h1>
