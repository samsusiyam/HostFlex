...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Roles & Permissions</h1>
    <p class="text-gray-500 dark:text-gray-400">Define what each user role can access</p>
</div>
...
<form method="POST">
<?= csrfField() ?>
<div class="bg-white rounded-lg shadow overflow-hidden mb-6 dark:bg-gray-800">
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            <thead>
                <tr class="bg-gray-50 border-b dark:bg-gray-700 dark:border-gray-600">
                    <th class="text-left px-4 py-3 font-semibold text-gray-600 dark:text-gray-300 w-48">Section</th>
                    <?php foreach ($roles as $role): ?>
                    <th class="text-center px-2 py-3 font-semibold text-gray-600 dark:text-gray-300 capitalize"><?php echo $role; ?></th>
                    <?php endforeach; ?>
                </tr>
            </thead>
            <tbody class="divide-y dark:divide-gray-600">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td class="px-4 py-3 font-medium text-gray-700 dark:text-gray-200"><?php echo $section_labels[$sec]; ?></td>
                    <?php foreach ($roles as $role): ?>
                    <td class="px-2 py-3 text-center">
                        ...
                        <div class="flex flex-wrap justify-center gap-1">
                            ...
                            <label class="text-xs flex items-center gap-0.5 cursor-pointer" title="<?php echo ucfirst($act); ?>">
                                ...
                                <span class="hidden sm:inline text-gray-500 dark:text-gray-400"><?php echo substr($act, 0, 1); ?></span>
                            </label>
                            <?php endforeach; ?>
                        </div>
                        <?php endif; ?>
...
<button type="submit" name="save_perms" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 dark:hover:bg-blue-600"><i class="fa fa-save mr-1"></i> Save Permissions</button>
</form>
