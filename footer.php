...
<h3><img class="max-h-[40px] max-w-[200px] sm:max-w-[400px] rounded" src="/<?php echo ltrim(getSetting('footer_logo') ?: 'images/logo-white.png', '/'); ?>" alt="<?php echo htmlspecialchars(getSetting('site_name') ?: 'Host Nibo'); ?>"></h3>
