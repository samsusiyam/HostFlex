...
<h3><img class="max-h-[40px] max-w-[200px] sm:max-w-[400px] rounded" src="<?php echo getSetting('footer_logo') ?: 'images/logo-white.png'; ?>" alt="<?php echo escSetting('site_name'); ?>" width="200" height="40" loading="lazy"></h3>
